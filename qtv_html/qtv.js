var VideoWallStates = {
	...
	"photo": {
		...
		updateContent: function(){
			...
			currentsrc = currentsrc.replace('.JPG', '.png').replace('.jpg', '.png');
	...
	"tv": {
		...
		playContent: function(clipurl){
			var flowflashplayer = flowplayer("tvplayer", "flowplayer/flowplayer-3.2.7.swf", {
				buffering: false,
				clip : {
					url: clipurl,
					scaling: 'fit',
			...
			VideoWallStates.tv.tvplayers[1] = new FlowFlashPlayer(flowflashplayer);
